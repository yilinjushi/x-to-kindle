...
There are a few practical considerations to ensure effective use of the prompt cache. First, the prompt cache is pinned to a specific model. Second, prompt cache reads must be byte-exact across the prefix. Finally, the prompt cache has a limited time-to-live (TTL).
...
Figure 1 | Claude Console can diagnose unexpected prompt cache misses by comparing requests and identifying exactly where the prompt prefix diverged.

![Article image](/assets/2026-09-09-reducing-cost-and-improving-performance-with-claude-platform-32eecac489/01.jpg)
...
Figure 2 | Organize prompts with caching in mind.

![Article image](/assets/2026-09-09-reducing-cost-and-improving-performance-with-claude-platform-32eecac489/02.jpg)
...
![Article image](/assets/2026-09-09-reducing-cost-and-improving-performance-with-claude-platform-32eecac489/03.jpg)
...
![Article image](/assets/2026-09-09-reducing-cost-and-improving-performance-with-claude-platform-32eecac489/04.jpg)
...
![Article image](/assets/2026-09-09-reducing-cost-and-improving-performance-with-claude-platform-32eecac489/05.jpg)
...
Figure 6 | Hillclimbing improves cost and performance.

![Article image](/assets/2026-09-09-reducing-cost-and-improving-performance-with-claude-platform-32eecac489/06.jpg)
...
It then ranks the available savings, starting with prompt caching, trimming what each request carries (including a prompt-audit), bounding output, and batching unattended work. If you supply an evaluation, it goes further and computes cost and performance across effort levels and model choices. We ran this on four public benchmarks with Sonnet 5 as a baseline (Figure 7):
...
![Article image](/assets/2026-09-09-reducing-cost-and-improving-performance-with-claude-platform-32eecac489/07.jpg)
